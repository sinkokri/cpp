...
public:
    ...
    virtual string   type        ( void )               const { return m_Type; }
    virtual bool     operator == ( const Base & other ) const { return other . type()  == ( * this ) . type(); }
    virtual bool     operator != ( const Base & other ) const { return other . type() != ( * this ) . type(); }
    virtual void     print       ( ostream & os )       const { os << type(); }
